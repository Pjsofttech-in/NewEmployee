...
public interface SalaryService
{
    ...
    Page<FlatSalaryDTO> getAllSalaryByEmpId(String role, String email, Long empId, Integer month, Integer year, int page, int size);
    ...
    MonthSalaryResponse getSalarySummary(String role, String email,int month, int year);
}
